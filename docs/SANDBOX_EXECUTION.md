...
- `SANDBOX_ALLOW`: comma list of command prefixes that *may* run in sandbox (e.g., `python,node`).
- `SANDBOX_DENY`: comma list of substrings that *must* go to sandbox (e.g., `rm -rf,/etc`).
